...
<link href="//stx1.ideone.com/gfx2/css/ideone-1-2.css?8"
	rel="stylesheet">
...
<script type="text/javascript"
	src="//stx1.ideone.com/gfx2/js/ideone-common.js?7"></script>
<!-- end of rzeczy przeniesione tymczasowo z bundle -->

<script src="http://ideone.com/gfx2/libs/ace-2013-08/mode-java.js"></script>
<script type="text/javascript" charset="utf-8" async=""
	src="https://platform.twitter.com/js/button.4e56ff84e57afaf5af2506ef73ab8a88.js"></script>
<style type="text/css">
.fb_hidden {
	position: absolute;
	top: -10000px;
		...
		<div class="span8 code-panel">
			...
			<div style="border-bottom: 1px solid #ececec;">
				<div id="file_div" class=" ace_editor ace-tm"
					...
					<textarea class="ace_text-input" wrap="hard" autocapitalize="off"
						spellcheck="false"
						style="bottom: 89.6px; height: 14.4px; width: 6.6px; right: 562.4px;"></textarea>
					<div class="ace_gutter">
						<div class="ace_layer ace_gutter-layer ace_folding-enabled"
							...
							<div class="ace_gutter-cell "
								style="height: 14.40000057220459px;">15</div>
							<div class="ace_gutter-cell "
								style="height: 14.40000057220459px;">16</div>
						</div>
						<div class="ace_gutter-active-line"
							style="top: 216px; height: 14.4px;"></div>
					</div>
					<div class="ace_scroller"
						style="left: 47px; right: 0px; bottom: 0px;">
						<div class="ace_content"
							style="margin-top: 0px; width: 573px; height: 348.8px; margin-left: 0px;">
							...
							<div class="ace_layer ace_marker-layer">
								<div class="ace_active-line"
									style="height: 14.40000057220459px; top: 216.00000858306885px; left: 0; right: 0;"></div>
							</div>
							<div class="ace_layer ace_text-layer" style="padding: 0px 4px;">
								...
								<div class="ace_line" style="height: 14.40000057220459px">
									<span class="ace_keyword">class</span>&nbsp;<span
										class="ace_identifier">C.Va</span>
								</div>
								<div class="ace_line" style="height: 14.40000057220459px">{</div>
								<div class="ace_line" style="height: 14.40000057220459px">
							...
							<div class="ace_layer ace_cursor-layer ace_hidden-cursors">
								<div class="ace_cursor"
									style="left: 4px; top: 216px; width: 6.6px; height: 14.4px;"></div>
							</div>
						</div>
					</div>
					<div
					...
					<div class="ace_scrollbar"
						...
						<div class="ace_scrollbar-inner" style="height: 230.4px;"></div>
					</div>
					<div class="ace_scrollbar-h"
						style="height: 26px; display: none; overflow-x: scroll; left: 47px; right: 0px;">
						<div class="ace_scrollbar-inner" style="width: 573px;"></div>
					</div>
				</div>
							...
							<div class="ex-more-options-box"
								...
								<div class="syntax-box">
									<input type="hidden" name="syntax" value="0"> <label
										...
										name="syntax" id="syntax" value="1" checked="checked">
			...
			<div class="row">
				<div class="span8">
					<div class="footer">
						...
						<!-- more options -->
						<a href="#" id="button-more-options" class=""> <span
						...
						<div class="pull-right">
							...
							<button type="submit" name="Submit" id="Submit" tabindex="2"
